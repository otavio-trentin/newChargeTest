...
class deviceResponse():
    ...
    def extractMSG(self):
        ...
        for i in range(6,6+self.bytesResponse*2,4): # i start from the 8th and go until the end of the double of the number of bytes response, the step is 4 cause this is the amount of bits in a register
